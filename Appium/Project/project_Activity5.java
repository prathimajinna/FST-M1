...
public class project_Activity5 {
	...
	public void Loginform() throws InterruptedException {
		...
		driver.findElement(MobileBy.AndroidUIAutomator(
				"new UiScrollable(new UiSelector().scrollable(true)).scrollDescriptionIntoView(\"Login Form Please sign in.\")"))
				.click();
	}
	...
	public void InCorrectcase() throws InterruptedException {
		...
		// click login button
		new TouchAction(driver).press(PointOption.point(1000, 1050)).waitAction().moveTo(PointOption.point(1000, 500))
				.release().perform();
		wait.until(ExpectedConditions.presenceOfElementLocated(MobileBy.AndroidUIAutomator("text(\"Log in\")")))
				.click();
